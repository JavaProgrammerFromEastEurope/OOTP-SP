...
class Exam extends ArrayList<Exam> implements Comparable<Exam>, Serializable {
    ...
    void setSubjectName(String subjectName) { this.subjectName   = subjectName;} //приваивание данных к полям
    void setScore(int Score)                { this.Score    = Score;}
    void setExamDate(Calendar examDate)     { this.examDate = examDate;}
