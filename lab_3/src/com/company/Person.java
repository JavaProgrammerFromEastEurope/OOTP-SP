 ...
 class Person  implements  Comparable<Person>, Comparator<Person> {
    ...
    public String toShortString() {
     ...
     public boolean equals(Object o) {
        ...
        return (lastName != null ? lastName.equals(person.lastName) : person.lastName == null) && (dateOfBirth != null ? dateOfBirth.equals(person.dateOfBirth) : person.dateOfBirth == null);
     }
    @Override
    public int hashCode() {
